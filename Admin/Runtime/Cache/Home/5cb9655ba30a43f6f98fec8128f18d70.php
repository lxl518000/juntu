...
<body class="gray-bg">
	...
	<?php echo formbuilder('input',array('title'=>'问题名称','name'=>'title','value'=>$list['title'],'placeholder'=>'请输入问题名称','validate'=>'required','tip'=>''));?>
	<?php echo formbuilder('textarea',array('title'=>'问题内容','name'=>'content','value'=>$list['content'],'placeholder'=>'','validate'=>'required','tip'=>''));?>
	<?php echo formbuilder('input',array('title'=>'排序','name'=>'sort','value'=>$list['sort'],'placeholder'=>'','validate'=>'required','tip'=>''));?>
