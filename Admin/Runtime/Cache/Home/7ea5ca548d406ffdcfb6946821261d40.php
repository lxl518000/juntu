...
<div class="alert alert-danger">当前路由表共 <b><?php echo ($count); ?></b> 条记录</div>
	<?php echo formbuilder('input',array('title'=>'版本号','name'=>'ver','value'=>$list['ver'],'placeholder'=>'请输入版本号','validate'=>'required','tip'=>''));?>
