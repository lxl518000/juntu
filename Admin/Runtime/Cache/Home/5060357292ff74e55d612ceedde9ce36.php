...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeIn">
        ...
        <div class="ibox float-e-margins">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap ">
                            ...
                            <div class="example" style='margin-top:5px;'>
                                ...
                                <label for="exampleInputEmail2" class="sr-only">问题名称</label>
                                <input type="text" name="title"  placeholder="问题名称"  class="form-control">
                      </div>
         ...
         <th data-field="addtime"  data-sortable="true">操作人</th>
