...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeIn">
        ...
        <div class="ibox float-e-margins">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap ">
                              ...
                              <?php echo getToolIcon('add','J_open btn-sm',U('add'));?>
                                <?php echo getToolIcon('delete','J_multiple btn-sm',U('delete'));?>
                                 ...
                                 <?php echo getToolIcon('off','J_multiple btn-sm',U('disable'));?>
                                   <?php echo getToolIcon('refresh','J_confirm btn-sm',U('cacheroomlevel'),'更新机房缓存');?>
                            ...
                            <div class="example" style='margin-top:5px;'>
                                ...
                                <label for="exampleInputEmail2" class="sr-only">机房名称</label>
                                <input type="text" name="name"  placeholder="机房名称"  class="form-control">
                      </div>
         ...
         <th data-field="id"  data-sortable="true">机房id</th>
         <th data-field="name"  data-sortable="true" >机房名称</th>
         <th data-field="mark"  data-sortable="true" >备注</th>
         <th data-field="status"  data-sortable="true" >状态</th>
         <th data-field="isp"  data-sortable="true">isp</th>
         <th data-field="pmark"  data-sortable="true">优先级</th>
         <th data-field="addtime"  data-sortable="true">修改时间</th>
         <th data-field="adduser"  data-sortable="true">修改人</th>
