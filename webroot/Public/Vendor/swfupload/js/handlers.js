...
function myuploadSuccess(file, serverData){
	try {
		...
		if (serverData.substring(0, 7) === "FILEID:") {
			str = '<div  style="width:100px;overflow:hidden;position:relative;float:left;"><img src="'+serverData.substring(7)+'" width="100"/><input type="hidden" name=pic[]" value="'+serverData.substring(7)+'"><img src="/Public/Vendor/swfupload/images/close.png" style="position:absolute;right:0;top:0;z-index:99" onclick="$(this).parent().remove();"/></div>';
