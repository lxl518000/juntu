                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                               <form class="AjaxBatch" data-action="/index.php/Home/Sysmenu" method="post">
                            ...
                            <table class="table  TreeTable">
                                ...
                                <tbody>
                                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($vo["id"]); ?>" pId="<?php echo ($vo["pid"]); ?>" >
                                        ...
                                        <td>
                                        <?php if(!empty($vo["icon"])): ?><i class="fa <?php echo ($vo["icon"]); ?>"></i><?php endif; ?>
                                       </td>
                                        <td><?php echo ($vo["sort"]); ?></td>
                                          <td class="tc"><?php echo int_str($vo['type'],'1:节点,2:菜单,3:分组');?></td>
