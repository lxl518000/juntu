...
<body class="gray-bg">
                   ...
                   <h5>&nbsp;&nbsp;&nbsp;<button class="btn btn-success " style='padding:5px' type="button" onclick="setResult()">&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold">图片选择完成后请点击此处完成预览区图片的上传！！&nbsp;&nbsp;&nbsp;&nbsp;</span>
                     ...
                     <div class="ibox-content " style='padding:5px 20px'>
                     	<div class='showthumb' style='min-height:80px;'>
                     	  <?php if(!empty($pics)): if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="/Public/static/img/a4.jpg" style='max-width:60px;'/><?php endforeach; endif; else: echo "" ;endif; ?>
		                     <?php else: ?>
		                     <div>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><a href="javascript:void(0)" data-url="<?php echo U('Public/showbd');?>" class='act choosetype'><i class="fa fa-upload"></i>&nbsp;&nbsp;本地上传</a>
                        &nbsp;&nbsp;/&nbsp;&nbsp;<a class="choosetype" data-url="<?php echo U('Public/showsc');?>" style='color:#333' href="javascript:void(0)" ><i class="fa fa-picture-o"></i>素材库选择</a></h5>
                    </div>
    ...
    function uploadCallBack(info){
    	addPic(info.savepath+info.thumbname);
    }
